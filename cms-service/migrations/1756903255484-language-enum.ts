...
export class LanguageEnum1756903255484 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."programs_language_enum" AS ENUM('en', 'ar')`,
    );
    await queryRunner.query(
      `ALTER TABLE "programs" ADD "language" "public"."programs_language_enum" NOT NULL DEFAULT 'ar'`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "programs" ADD "language" character varying NOT NULL DEFAULT 'en'`,
    );
  }
}
