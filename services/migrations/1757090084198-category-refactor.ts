...
export class CategoryRefactor1757090084198 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "programs" RENAME COLUMN "category" TO "categoryId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "programs" ADD CONSTRAINT "FK_a20853fe73e393a2ea0f10809b2" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "programs" DROP CONSTRAINT "FK_a20853fe73e393a2ea0f10809b2"`,
    );
    await queryRunner.query(`ALTER TABLE "programs" DROP COLUMN "categoryId"`);
    await queryRunner.query(
      `ALTER TABLE "programs" ADD "categoryId" character varying NOT NULL`,
    );
    await queryRunner.query(`DROP TABLE "categories"`);
    await queryRunner.query(
      `ALTER TABLE "programs" RENAME COLUMN "categoryId" TO "category"`,
    );
  }
}
